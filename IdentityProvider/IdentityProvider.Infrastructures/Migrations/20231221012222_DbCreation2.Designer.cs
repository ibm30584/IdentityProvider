...
namespace IdentityProvider.Infrastructures.Migrations
{
    ...
    [Migration("20231221012222_DbCreation2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("IdentityProvider.Domain.Entities.AppUser", b =>
                {
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.Client", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2023, 12, 21, 1, 22, 21, 544, DateTimeKind.Utc).AddTicks(2743),
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2023, 12, 21, 1, 22, 21, 544, DateTimeKind.Utc).AddTicks(3110),
                            DeviceCodeLifetime = 300,
                            EnableLocalLogin = true,
                            Enabled = true,
                            FrontChannelLogoutSessionRequired = true,
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientPostLogoutRedirectUri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 2,
                            PostLogoutRedirectUri = "https://localhost:6001/index"
                        });
                });
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientRedirectUri", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 2,
                            RedirectUri = "https://localhost:6001/code-callback"
                        });
                });
            ...
            modelBuilder.Entity("IdentityServer4.EntityFramework.Entities.ClientSecret", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ClientId = 1,
                            Created = new DateTime(2023, 12, 21, 1, 22, 21, 544, DateTimeKind.Utc).AddTicks(2999),
                            Type = "SharedSecret",
                            Value = "MDhSB0YCGXC9qLCYIRJdHx8JhfZuF3Axj4BlWs+28SA="
                        });
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("IdentityProvider.Domain.Entities.AppUser", null)
                        .WithMany()
